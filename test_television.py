...
class Test:
    ...
    def test_mute(self):
        #on, volume increased once, muted
        self.tv1.power()
        self.tv1.volume_up()
        self.tv1.mute()
        assert self.tv1.__str__() == 'Power = True, Channel = 0, Volume = 0'
    ...
    def test_channel_down(self):
        ...
        #on, channel decreased past minimum value
        self.tv1.power()
        self.tv1.channel_down()
    ...
    def test_volume_down(self):
        ...
        #on, decreased past minimum value
        self.tv1.volume_down()
        assert self.tv1.__str__() == 'Power = True, Channel = 0, Volume = 0'